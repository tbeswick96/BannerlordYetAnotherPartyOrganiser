...
namespace YAPO.Configuration
{
    public static class JsonFileService
    {
        ...
        public static SorterConfigurationContainer Load()
        {
            ...
            {
                ModDebug.ShowError("Failed to load sorter configuration file for YetAnotherPartyOrganiser. Configurations have not been loaded and will get overwritten on next game save",
                                   "JsonFileService Load exception",
                                   exception);
            }
        ...
        public static void Save(SorterConfigurationContainer configurationContainer)
        {
            ...
            {
                ModDebug.ShowError("Failed to save sorter configuration file for YetAnotherPartyOrganiser. Configurations have not been saved and won't load correctly on next game load",
                                   "JsonFileService Save exception",
                                   exception);
            }
        }
    }
