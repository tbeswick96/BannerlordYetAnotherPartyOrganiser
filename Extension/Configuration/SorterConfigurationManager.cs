    ...
    public class SorterConfigurationManager {
        ...
        public void SaveConfigurations() {
            ...
            try {
                ...
                ModDebug.ShowError($"YetAnotherPartyOrganiser failed to find sorter configuration for the current save {States.NewSaveName}." + "This shouldn't happen, please report this error by creating an issue on our github page",
        ...
        private void RemoveOldSaveConfigurations() {
            _configurationContainer.ConfigurationSaves = _configurationContainer.ConfigurationSaves.OrderByDescending(x => x.LastSaved).Where(x => !string.IsNullOrEmpty(x.SaveName)).Take(50).ToList();
        }
