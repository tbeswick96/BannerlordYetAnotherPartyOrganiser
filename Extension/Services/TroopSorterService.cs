...
namespace YAPO.Services
{
    public static class TroopSorterService
    {
        ...
        {
            sortedTroops =
                configuration.CurrentThenByMode == SortMode.NONE ||
                configuration.CurrentThenByMode == configuration.CurrentSortByMode
                    ...
                    : sortedTroops.SortBy(configuration.CurrentSortByMode, configuration.SortDirection)
                                  .ThenSortBy(configuration.CurrentThenByMode,
                                              configuration.SortOrderOpposite
                                                  ? configuration.SortDirection.InvertDirection()
            ...
            upgradableTroops = upgradableTroops
                              .OrderByDescending(x => x.Character.UpgradeRequiresItemFromCategory == null)
                              .ToList();
